/*
   Last Modified Time: April 4, 2026 at 7:15:10 AM
*/
...
/************************************************************
 * THIS LIBRARY IS SLIGHTLY MODIFIED FROM THE DEKAY ORIGINAL.
 * THE MODIFICATIONS SUPPORT USING A ESP8266/ESP32
 ************************************************************/
...
// ******** THESE MUST BE SET ************
#define RFM_RESET       17      // pin for RFM69 reset function
#define RFM_SS           4      // pin used for RFM select
#define RFM_INT         16      // pin used for interrupt from RFM
// ***************************************

#define PACKET_INTERVAL 2560
...
// INT0 on AVRs should be connected to RFM69's DIO0 (ex on ATmega328 it's D2, on ATmega644/1284 it's D2)
  ...
  #define RF69_IRQ_PIN 2
  #define RF69_IRQ_NU7M 2
#elif defined(__AVR_ATmega32U4__)
  #define RF69_IRQ_PIN 3
  #define RF69_IRQ_NUM 0
#elif defined(ESP8266) || defined (ESP32) // <----
  #define RF69_IRQ_PIN 3                  // <---- Doesnt appear to be used
  #define RF69_IRQ_NUM RFM_INT            // <---- ESP8266/ESP32 input pin to which the RFM69 interupt output is connected
#endif                                    // <----
...
//   bool initialize(uint8_t ssPin, uint8_t intPin);
    bool initialize(uint8_t intPin, SPIClass* _xspi); // <<<<<<<<
    bool canSend();
    ...
    void readAllRegs(char * dbuf);
    void readSetRegs(char * dbuf);
    void CollectData();
    void setRegisters(char * text);
...
{
  {0xD9, 0x04, 0x45}, // 868.066 MHz
  {0xD9, 0x13, 0x04}, // 868.297 MHz
  {0xD9, 0x21, 0xC2}, // 868.527 MHz
  {0xD9, 0x0B, 0xA4}, // 868.181 MHz
  {0xD9, 0x1A, 0x63}  // 868.412 MHz
};
...
/* 
  PacketStats packetStats = {0, 0, 0, 0 ,0, 0, 
                                  false, 
                                  DAVIS_FREQ_TABLE_LENGTH, 
                                  PACKET_INTERVAL + 200}; 
*/
